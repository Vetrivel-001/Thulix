...
export const JOURNEY_STEPS = [
  { n: '01', title: 'Discover', text: 'AI assesses your goals, strengths and interests to map the right direction for your career.', icon: 'compass', accent: '#059669' },
  { n: '02', title: 'Choose Learning Path', text: 'Pick from a personalized roadmap crafted from 2,500+ courses, micro-learning and live sessions.', icon: 'route', accent: '#047857' },
  { n: '03', title: 'Learn', text: 'Absorb knowledge through video, reading, interactive exercises and AI-generated study plans.', icon: 'book', accent: '#2563EB' },
  ...
  { n: '05', title: 'Build Projects', text: 'Ship real-world projects with feedback loops from AI reviewers and expert mentors.', icon: 'rocket', accent: '#059669' },
  { n: '06', title: 'Earn Certificates', text: 'Earn verifiable, shareable certificates and badges that prove your skills to the world.', icon: 'award', accent: '#7C3AED' },
  { n: '07', title: 'Create Portfolio', text: 'SkillBridge AI composes a stunning portfolio and resume from your projects automatically.', icon: 'briefcase', accent: '#2563EB' },
  ...
  { n: '09', title: 'Interview', text: 'Practice with AI mock interviews, then ace real ones with recruiters who already know your work.', icon: 'mic', accent: '#059669' },
  { n: '10', title: 'Get Hired', text: 'Receive offers from a talent pool where skills — not keywords — decide your value.', icon: 'trophy', accent: '#7C3AED' },
  { n: '11', title: 'Grow Your Career', text: 'Continuous AI guidance for promotions, upskilling, mentorship and your next big leap.', icon: 'trend', accent: '#2563EB' },
]

export const STUDENT_FEATURES = [
  { icon: 'dashboard', label: 'Learning Dashboard', color: '#059669' },
  { icon: 'map', label: 'AI Learning Roadmap', color: '#047857' },
  { icon: 'clipboard', label: 'Assignments', color: '#06B6D4' },
  { icon: 'terminal', label: 'Coding Playground', color: '#10B981' },
  { icon: 'rocket', label: 'Projects', color: '#059669' },
  { icon: 'layout', label: 'Portfolio Builder', color: '#047857' },
  { icon: 'file', label: 'Resume Builder', color: '#06B6D4' },
  { icon: 'briefcase', label: 'Internship Portal', color: '#10B981' },
  { icon: 'search', label: 'Job Portal', color: '#059669' },
  { icon: 'award', label: 'Certificates', color: '#047857' },
  { icon: 'chart', label: 'Learning Analytics', color: '#06B6D4' },
  { icon: 'bookmark', label: 'Bookmarks', color: '#10B981' },
  { icon: 'gauge', label: 'Progress Tracking', color: '#059669' },
  { icon: 'calendar', label: 'Study Planner', color: '#047857' },
  { icon: 'gamepad', label: 'Gamification', color: '#06B6D4' },
  { icon: 'shield', label: 'Badges & XP', color: '#10B981' },
  { icon: 'flame', label: 'Learning Streak', color: '#059669' },
]

export const TRAINER_FEATURES = [
  { icon: 'play-circle', label: 'Create Courses', color: '#7C3AED' },
  { icon: 'upload', label: 'Upload Videos', color: '#059669' },
  { icon: 'video', label: 'Live Classes', color: '#2563EB' },
  { icon: 'clipboard', label: 'Assignments', color: '#10B981' },
  { icon: 'check-square', label: 'Quizzes', color: '#7C3AED' },
  { icon: 'users', label: 'Student Analytics', color: '#059669' },
  { icon: 'trend', label: 'Course Performance', color: '#2563EB' },
  { icon: 'wallet', label: 'Revenue Dashboard', color: '#10B981' },
  { icon: 'message', label: 'Community Discussions', color: '#7C3AED' },
  { icon: 'award', label: 'Certificates', color: '#059669' },
  { icon: 'hand', label: 'Mentorship', color: '#2563EB' },
]

export const RECRUITER_FEATURES = [
  { icon: 'building', label: 'Company Dashboard', color: '#2563EB' },
  { icon: 'briefcase', label: 'Post Jobs', color: '#7C3AED' },
  { icon: 'clock', label: 'Post Internships', color: '#059669' },
  { icon: 'sparkles', label: 'Talent Discovery', color: '#10B981' },
  { icon: 'filter', label: 'Candidate Filtering', color: '#2563EB' },
  { icon: 'file', label: 'Resume Preview', color: '#7C3AED' },
  { icon: 'calendar', label: 'Interview Scheduling', color: '#059669' },
...
export const FEATURES = [
  { icon: 'sparkles', title: 'AI Mentor', text: 'A personal AI mentor that learns your pace, answers instantly, and keeps you accountable around the clock.', color: '#059669' },
  { icon: 'file', title: 'Resume Builder', text: 'Generate ATS-optimized resumes from your verified projects, skills and achievements in one click.', color: '#2563EB' },
  { icon: 'layout', title: 'Portfolio Builder', text: 'Your projects transform into a stunning personal portfolio site \u2014 hosted, shareable and recruiter-ready.', color: '#7C3AED' },
  ...
  { icon: 'terminal', title: 'Coding Playground', text: 'A browser IDE with 40+ languages, instant feedback and challenge-based drills that sharpen your skills.', color: '#059669' },
  { icon: 'map', title: 'Career Roadmaps', text: 'AI-crafted step-by-step roadmaps from where you are today to the role you want tomorrow.', color: '#2563EB' },
  { icon: 'video', title: 'Live Classes', text: 'Interactive live sessions with top trainers, real-time polls, Q&A and session replays.', color: '#7C3AED' },
  ...
  { icon: 'rocket', title: 'Projects', text: 'Industry-grade projects that double as proof \u2014 reviewed, scored and portfolio-ready.', color: '#059669' },
  { icon: 'award', title: 'Certificates', text: 'Blockchain-verifiable certificates that recruiters can authenticate instantly.', color: '#2563EB' },
  { icon: 'message', title: 'Discussion Forum', text: 'Ask anything, share insights and get answers from a thriving community of learners and experts.', color: '#7C3AED' },
  ...
  { icon: 'trophy', title: 'Hackathons', text: 'Weekly online hackathons with real sponsors, cash prizes and direct recruiter visibility.', color: '#059669' },
  { icon: 'bar-chart', title: 'Leaderboards', text: 'Earn XP, climb global and domain leaderboards, and turn learning into a competitive sport.', color: '#2563EB' },
  { icon: 'bookmark', title: 'Bookmarks', text: 'Save courses, lessons, resources and jobs into smart collections that sync across devices.', color: '#7C3AED' },
  ...
  { icon: 'play-circle', title: 'Video Learning', text: 'Cinema-grade lesson videos with transcripts, chapters, speed control and smart captions.', color: '#059669' },
  { icon: 'briefcase', title: 'Job Portal', text: 'A skill-first job board where verified candidates match openings without keyword lottery.', color: '#2563EB' },
  { icon: 'clock', title: 'Internships', text: 'Campus-to-corporate internship tracks with real company projects and stipend support.', color: '#7C3AED' },
  ...
  { icon: 'chart', title: 'Learning Analytics', text: 'Deep insights into time spent, mastery curves, focus patterns and career-readiness scores.', color: '#059669' },
  { icon: 'calendar', title: 'Study Planner', text: 'An AI planner that blocks your schedule, balances subjects and defends your focus time.', color: '#2563EB' },
  { icon: 'compass', title: 'Career Guidance', text: 'Role-matching, salary insights and growth paths shaped by live industry demand data.', color: '#7C3AED' },
...
export const LIVE_ACTIVITY = [
  { actor: 'Rahul S.', action: 'completed the Java Certification', time: '2m ago', color: '#059669', icon: 'award' },
  { actor: 'Priya K.', action: 'earned a Gold Badge in AI & ML', time: '7m ago', color: '#F59E0B', icon: 'shield' },
  { actor: 'Microsoft', action: 'posted a new Frontend Internship', time: '14m ago', color: '#2563EB', icon: 'briefcase' },
  { actor: 'Arun T.', action: 'uploaded a React Advanced course', time: '21m ago', color: '#7C3AED', icon: 'video' },
  { actor: 'SkillBridge AI', action: 'generated a new learning roadmap', time: '33m ago', color: '#10B981', icon: 'sparkles' },
  { actor: 'Meera N.', action: 'solved a Hard-level coding challenge', time: '41m ago', color: '#059669', icon: 'terminal' },
  { actor: 'Amazon', action: 'scheduled 12 interviews from the pool', time: '55m ago', color: '#7C3AED', icon: 'calendar' },
  { actor: 'Sneha R.', action: 'completed the Data Structures path', time: '1h ago', color: '#2563EB', icon: 'trophy' },
  { actor: 'Vikram P.', action: 'achieved a 100-day learning streak', time: '1h ago', color: '#10B981', icon: 'flame' },
  { actor: 'TCS', action: 'posted 3 new Data Analyst roles', time: '2h ago', color: '#059669', icon: 'briefcase' },
  { actor: 'Kavya D.', action: 'earned the React Certified badge', time: '2h ago', color: '#7C3AED', icon: 'award' },
  { actor: 'OpenAI-expert trainer', action: 'launched a Prompt Engineering course', time: '3h ago', color: '#2563EB', icon: 'video' },
]
...
export const TESTIMONIALS = [
  {
    ...
    color: '#059669',
    rating: 5,
    quote: 'SkillBridge AI didn\u2019t just teach me React \u2014 it built my resume, drilled me with AI interviews and placed me at Microsoft. My whole career changed in 7 months.',
  ...
  },
  {
    ...
    journey: 'Freelance trainer \u2192 Top 1% educator on SkillBridge AI',
    featured: false,
  },
]

export const STATS = [
  { value: 100000, suffix: '+', label: 'Learners', sub: 'across 90+ countries', color: '#059669' },
  { value: 2500, suffix: '+', label: 'Courses', sub: 'curated & AI-mapped', color: '#7C3AED' },
  { value: 1000, suffix: '+', label: 'Recruiters', sub: 'hiring verified talent', color: '#2563EB' },
  { value: 600, suffix: '+', label: 'Expert Trainers', sub: 'from top companies', color: '#10B981' },
  { value: 95, suffix: '%', label: 'Career Success Rate', sub: 'within 6 months', color: '#059669' },
]

export const HIGHLIGHTS = [
  { icon: 'lock', title: 'Secure Authentication', text: 'OAuth2, SSO, MFA and encrypted sessions keep every account fortress-grade.', color: '#059669' },
  { icon: 'users', title: 'Role-Based Experience', text: 'Dedicated workspaces for students, trainers and recruiters \u2014 tailored end to end.', color: '#7C3AED' },
  { icon: 'sparkles', title: 'AI Personalization', text: 'Every roadmap, feed and recommendation adapts to you in real time.', color: '#2563EB' },
  { icon: 'cloud', title: 'Cloud Infrastructure', text: 'Globally distributed, auto-scaling architecture with 99.99% uptime.', color: '#10B981' },
  { icon: 'zap', title: 'Fast Performance', text: 'Edge-rendered pages, sub-second loads and 100/100 Lighthouse scores.', color: '#059669' },
  { icon: 'eye', title: 'Privacy First', text: 'Your data is yours. Zero third-party tracking, full GDPR & DPDP compliance.', color: '#7C3AED' },
  { icon: 'bell', title: 'Real-Time Notifications', text: 'Instant alerts on matches, offers, streaks, and community moments.', color: '#2563EB' },
...
export const FAQS = [
  ...
  {
    q: 'How do companies hire through SkillBridge AI?',
