...
const copy = {
  login: { eyebrow: 'Welcome back', title: 'Sign in to Thulix', sub: 'Your intelligent workspace is waiting. Secure, seamless and ready when you are.' },
  ...
  about: { eyebrow: 'About', title: 'Why we built Thulix', sub: 'Because education should end in opportunity - for everyone.' },
  contact: { eyebrow: 'Contact', title: "Let's build the future together", sub: 'Partnerships, press and hello@thulix.ai.' },
}
...
export default function Placeholder() {
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-abyss pt-32 pb-20">
      <div aria-hidden="true" className="absolute inset-0 grid-bg" />
      <div aria-hidden="true" className="absolute inset-0">
        <div className="orb left-[-10%] top-[-5%] h-[460px] w-[460px] bg-electric/10 animate-aurora-a" />
        <div className="orb right-[-10%] bottom-[-10%] h-[420px] w-[420px] bg-neon/10 animate-aurora-b" />
      </div>
      ...
      >
        <span className="inline-flex items-center gap-2 rounded-full border border-border glass px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.22em]">
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link
            to="/"
            className="group inline-flex items-center gap-2 rounded-full border border-border glass px-7 py-3.5 text-sm font-semibold text-snow transition-all duration-300 hover:border-electric/30 hover:shadow-glow-electric"
          >
